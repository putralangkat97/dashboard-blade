    ...
    <div @click.away="open = false" class="flex flex-col w-full text-white flex-shrink-0 border-b lg:border-0"
            ...
            <a href="{{ route('dashboard') }}">
                ...
                <div class="hidden lg:flex items-center space-x-3 mt-6">
                    ...
                    <div class="flex flex-col">
                        <span class="text-gray-800 font-medium text-lg">{{ Auth::user()->name }}</span>
        ...
        <nav :class="{ 'block': open, 'hidden': !open }" class="flex-grow items-left lg:block px-6 pb-0 lg:pb-8">
            ...
            <div class="space-y-3 mb-4">
                ...
                <a href="#"
                    class="flex flex-row items-center hover:bg-teal-800/10 hover:text-gray-800 mt-3 lg:mt-0 px-4 py-2 transition-colors duration-300 rounded-full text-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-ticket w-7 h-7 mr-2"
                        width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M15 5l0 2" />
            ...
            <div class="space-y-3 mb-4">
                <a href="{{ route('profile.show') }}"
                    class="flex flex-row items-center hover:bg-teal-800/10 hover:text-gray-800 mt-3 lg:mt-0 px-4 py-2 transition-colors duration-300 rounded-full {{ request()->routeIs('profile.show') ? 'text-gray-800 bg-teal-800/10' : 'text-gray-800' }}">
